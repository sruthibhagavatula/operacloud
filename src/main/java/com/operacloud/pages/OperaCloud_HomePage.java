...
public class OperaCloud_HomePage extends OperaCloudSeleniumActions {

	public OperaCloud_HomePage(ChromeDriver driver, ExtentTest node) {
	...
	public OperaCloud_HomePage clickUserOptions() throws IOException {
		try {
			Thread.sleep(5000);
	...
	public OperaCloud_HomePage clickSelectLocation() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
	...
	public OperaCloud_HomePage enterTextToSearch(String searchTxt) throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
	...
	public OperaCloud_HomePage clickSearchButton() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
	...
	public OperaCloud_HomePage clickSelectButton() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
	...
	public OperaCloud_HomePage clickMenuOption() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
			Actions act = new Actions(driver);
	...
	public OperaCloud_HomePage clickOnSettings() throws InterruptedException, IOException {
	...
	public OperaCloud_HomePage clickOnSave() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
	...
	public OperaCloud_HomePage clickOnClearCache() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
	...
	public OperaCloud_HomePage clickOnPopUpClearCache() throws InterruptedException, IOException {
		try {
			Thread.sleep(2000);
	...
	public OperaCloud_HomePage clickOnAddTitles() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
	...
	public OperaCloud_HomePage clickOnViewLogs() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
	...
	public OperaCloud_HomePage switchTabToSettings() throws InterruptedException, IOException {
		try {
	...
	public OperaCloud_HomePage enterQuantityToTile(String tileNumber, String quantity)
	...
	public OperaCloud_HomePage clickOnAddToDashboard() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
	...
	public OperaCloud_HomePage clickOnAboutOperaCloud() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
	...
	public OperaCloud_HomePage clickOnClose() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
	...
	public OperaCloud_HomePage clickShowMore() throws InterruptedException, IOException {
		try {
	...
	public OperaCloud_HomePage clickOnReports() throws InterruptedException, IOException {
		try {
			Thread.sleep(10000);
			clickReports.click();
			Thread.sleep(8000);
	...
	public OperaCloud_HomePage clickOnOperaCloud() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
	...
	public OperaCloud_HomePage clickOnBookings() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
			clickBookings.click();
			Thread.sleep(8000);
	...
	public OperaCloud_HomePage clickOnReservations() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
	...
	public OperaCloud_HomePage clickOnClientRelations() throws InterruptedException, IOException {
		try {
			Thread.sleep(8000);
	...
	public OperaCloud_HomePage clickOnProfiles() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
			clickProfiles.click();
			Thread.sleep(3000);
	...
	public OperaCloud_HomePage clickOnMiscellaneous() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
	...
	public OperaCloud_HomePage clickOnExports() throws InterruptedException, IOException {
		try {
			Thread.sleep(5000);
			clickExports.click();
			Thread.sleep(5000);
